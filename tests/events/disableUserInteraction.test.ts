...
import { disableUserInteraction } from "@/events/actions";
...
describe("disableUserInteraction", () => {
  ...
  it("should add default class 'on_processing' to document.documentElement", () => {
    ...
    expect(document.documentElement.classList.contains("on_processing")).toBe(true);
  });

  it("should add custom class to document.documentElement", () => {
    disableUserInteraction("my_custom_class");
    expect(document.documentElement.classList.contains("my_custom_class")).toBe(true);
  });
