...
describe("parseCurrencyString - quirky realistic edge cases ++", () => {
  ...
  it("handles long mixed decimal with trailing currency", () => {
    ...
    expect(parseCurrencyString("1,123,234.12345 Rp")).toBeCloseTo(1123234.12345);
    expect(parseCurrencyString("1,123,234.19191919 Rp")).toBeCloseTo(1123234.19191919);
  });
  ...
  it("handles mixed thousands separators with emoji in between", () => {
    expect(parseCurrencyString("1.2,3'4💵5 6\u00A07,89")).toBeCloseTo(1.23456789);
  });
