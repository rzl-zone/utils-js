...
describe("isDeepEqual", () => {
  ...
  it("should compare Dates by time", () => {
    expect(isDeepEqual(new Date("2025-01-01"), new Date("2025-01-01"))).toBe(true);
    expect(isDeepEqual(new Date("2025-01-01"), new Date("2025-01-02"))).toBe(false);
  });
...
describe("isDeepEqual 2", () => {
  ...
  it("should deeply compare Maps", () => {
    ...
    expect(isDeepEqual(new Map([["a", { x: 10 }]]), new Map([["a", { x: 10 }]]))).toBe(
      true
    );
