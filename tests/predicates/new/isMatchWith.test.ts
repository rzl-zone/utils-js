...
import { isMatchWith } from "@/predicates/new/extends-lodash/isMatchWith";
...
describe("isMatchWith (extended cases)", () => {
  it("should match nested arrays with customizer", () => {
    ...
    const customizer: isMatchWithCustomizer = (objVal, srcVal) => {
  ...
  it("should compare Date values correctly", () => {
    ...
    const customizer: isMatchWithCustomizer = () => undefined;
